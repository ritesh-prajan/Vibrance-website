...
const STORAGE_KEYS = {
  ...
  USERS: 'vibrance26_users_v6',
  EVENTS: 'vibrance26_events_v6',
  BOOKINGS: 'vibrance26_bookings_v6',
  LOGS: 'vibrance26_audit_logs_v6',
  SCANS: 'vibrance26_scan_history_v6',
  SIM_HISTORY: 'vibrance26_sim_history_v6',
};
