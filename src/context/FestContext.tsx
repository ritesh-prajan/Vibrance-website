...
const STORAGE_KEYS = {
  ...
  USERS: 'vibrance26_users_v5',
  EVENTS: 'vibrance26_events_v5',
  BOOKINGS: 'vibrance26_bookings_v5',
  LOGS: 'vibrance26_audit_logs_v5',
  SCANS: 'vibrance26_scan_history_v5',
  SIM_HISTORY: 'vibrance26_sim_history_v5',
};
