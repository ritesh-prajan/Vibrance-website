...
export const INITIAL_EVENTS: FestEvent[] = [
  {
    ...
    date: 'Mon, Aug 31, 2026 • LIVE STAGE',
    time: '05:00 PM IST',
    ...
    ticketBgImage: 'https://images.unsplash.com/photo-1547153760-18fc86324498?w=1000&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    ticketBgImage: 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?w=1000&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    ticketBgImage: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=1000&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    lockedSeatsCount: 2,
    bookedSeatsCount: 34,
    tag: 'UPCOMING THURSDAY FINALE',
    shortDesc: 'Electrifying progressive house, visual pyrotechnics, and Indian electronic fusion soundscape.',
    ticketBgImage: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=1000&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    title: 'CYBERQUEST',
    category: 'HACKATHON',
    artistOrHost: 'Helen Vijitha P',
    date: 'Sat, Sep 5, 2026',
    time: '11:18 AM IST',
    venue: 'Nethaji 7TH Floor',
    basePrice: 100,
    totalSeats: 48,
    availableSeats: 46,
    lockedSeatsCount: 0,
    bookedSeatsCount: 2,
    tag: '_Capture. Decode. Defend_',
    shortDesc: 'Capture. Decode. Defend. School of Computer Science and Engineering (SCOPE) & Cybercom Hackathon.',
    ticketBgImage: '/cyberquest-ticket.png',
    seats: generateSeatsForEvent('evt-cyberquest', 100, 46),
    startTimestamp: NOW + EVENT_SCHEDULE_OFFSETS['evt-cyberquest'].startOffset,
    endTimestamp: NOW + EVENT_SCHEDULE_OFFSETS['evt-cyberquest'].startOffset + 24 * HOUR,
  },
  {
    id: 'evt-band',
    ...
    date: 'Sun, Aug 30, 2026 • CONCLUDED',
    time: '04:00 PM IST',
    ...
    ticketBgImage: 'https://images.unsplash.com/photo-1465847899084-d164df4dedc6?w=1000&auto=format&fit=crop&q=80',
  ...
  },
  {
    ...
    date: 'Sat, Aug 29, 2026 • CONCLUDED',
    time: '09:00 AM IST',
    ...
    ticketBgImage: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?w=1000&auto=format&fit=crop&q=80',
...
export const INITIAL_BOOKINGS: Booking[] = [
  {
    id: 'bk-cyberquest-01',
    bookingRef: 'VIB26-HAC-DEMO99',
    eventId: 'evt-cyberquest',
    eventTitle: 'CYBERQUEST',
    eventCategory: 'HACKATHON',
    artistOrHost: 'Helen Vijitha P',
    eventDate: 'Sat, Sep 5, 2026',
    eventTime: '11:18 AM IST',
    eventVenue: 'Nethaji 7TH Floor',
    seatId: 'evt-cyberquest-A1',
    seatLabel: 'A-1',
    seatCategory: 'VIP_FRONT',
    studentName: 'Sample Student Attendee',
    regNumber: 'RA2111003010142',
    department: 'Computer Science & Engineering (SCOPE)',
    amount: 150,
    paymentMethod: 'UPI',
    bookedAt: NOW - 3600000 * 2,
    qrPayload: 'VIBRANCE26-TICKET-VIB26-HAC-DEMO99-evt-cyberquest-A1-RA2111003010142',
    ticketBgImage: '/cyberquest-ticket.png',
    status: 'confirmed',
    startTimestamp: NOW + EVENT_SCHEDULE_OFFSETS['evt-cyberquest'].startOffset,
    endTimestamp: NOW + EVENT_SCHEDULE_OFFSETS['evt-cyberquest'].startOffset + 24 * HOUR,
  },
  {
    ...
    artistOrHost: 'Armaan Malik & 8-Piece Band',
    eventDate: 'Mon, Aug 31, 2026 • 07:30 PM',
  ...
  },
  {
    ...
    eventCategory: 'DANCE',
    artistOrHost: 'National Dance League Finalists',
    eventDate: 'Mon, Aug 31, 2026 • LIVE STAGE',
  ...
  },
  {
    ...
    eventCategory: 'HACKATHON',
    artistOrHost: 'Dept. of CSE & Tech Club',
    eventDate: 'Sat, Aug 29, 2026 • CONCLUDED',
