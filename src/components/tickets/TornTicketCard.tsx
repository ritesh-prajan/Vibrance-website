...
import { Calendar, Clock, MapPin, QrCode, ShieldCheck } from 'lucide-react';
          ...
          <div className="flex items-center justify-between gap-3 pb-3 border-b border-white/10">
            <div className="flex items-center gap-3">
              <img
                ...
                alt="Vibrance"
                className="w-10 h-10 rounded-full object-cover opacity-80 ring-1 ring-white/20 bg-black"
              />
              <div>
